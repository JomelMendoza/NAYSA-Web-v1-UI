...
//           input: "text",
//           inputLabel: "CSV Name",
//           inputValue: `Report_${getDateTimeStamp()}`,
...
//                 }`}
//               >
//                 <FontAwesomeIcon icon={faLayerGroup} className="mr-1" /> Drag
//                 column here to Group
//               </div>
//             )}
...
//                     tableSize === "Half" ? "h-7 text-[10px] px-2" : "h-8 text-xs px-3"
//                   }`}
//                 >
...
//                 <div className="relative flex-1" data-sgrt-export>
//                   <button
//                     onClick={() =>
//                       filteredData.length > 0 && setShowExportMenu(!showExportMenu)
//                     }
//                     disabled={filteredData.length === 0}
//                     className="w-full h-9 px-3 text-xs font-medium text-white bg-green-600 rounded-md hover:bg-green-700 disabled:opacity-50 transition flex items-center justify-center"
//                   >
...
//                 <div className="relative flex-1" data-sgrt-cols>
//                   <button
//                     onClick={() => setShowColumnChooser(!showColumnChooser)}
//                     className="w-full h-9 px-3 text-xs font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 transition flex items-center justify-center"
//                   >
...
//                                   ? baseVisibleColumns.map((c) => c.key)
//                                   : [],
//                               )
//                             }
//                           />
...
//                 <div className="flex items-center rounded-md overflow-hidden border border-gray-300 bg-white shrink-0">
//                   <button
//                     type="button"
//                     onClick={() => setMobileViewMode("table")}
//                     className={`px-3 h-9 text-[11px] font-medium transition flex items-center ${
...
//                     className={`px-3 h-9 text-[11px] font-medium transition border-l border-gray-300 flex items-center ${
//                       mobileViewMode === "card"
//                         ? "bg-blue-600 text-white"
//                         : "bg-white text-gray-700 hover:bg-gray-50"
//                     }`}
...
//                         {visibleCols[0] && (
//                           <span className="text-[11px] font-bold text-blue-900 pr-2">
...
//                 }`}
//                 style={autoFillGridState ? { tableLayout: "fixed" } : { tableLayout: "auto" }}
//               >
...
//                             key={col.key}
//                             style={getCellWidthStyle(col)}
//                             className={`px-1.5 py-1 text-[11px] leading-tight text-gray-700 whitespace-nowrap ${
//                               col.renderType === "number" ||
//                               col.renderType === "currency"
...
//                   <th
//                     key={c.key}
//                     className="border p-2 text-xs uppercase"
//                   >
//                     {c.label}
//                   </th>
//                 ))}
