...
//       try {
//         const finalStatus = stat === "ALL" ? "" : stat;
...
//         ? useformatToDatev2(row.receivedDate)
//         : useGetCurrentDayV2();
...
//           ? useformatToDatev2(row.returnedDate)
//           : "",
...
//                   className="shrink-0 px-3 py-2 text-xs font-medium rounded-md text-white bg-blue-600 hover:opacity-90 flex items-center"
//                 >
