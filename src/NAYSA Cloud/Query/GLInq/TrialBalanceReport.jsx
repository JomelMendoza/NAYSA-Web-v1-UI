...
// function TrialBalanceReport({ view, tabConfig, SearchGlobalReportTable, NoRecordsState }) {
//   if (!view.hasLoaded) {
//     return (
...
//       key={`trialBalance-${view.loadedAt || "idle"}`}
//       columns={view.cols}
//       data={view.rows}
//       itemsPerPage={50}
...
// TrialBalanceReport.buildPayload = (f) => ({
...
// TrialBalanceReport.buildJsonData = (payload) => ({
//   mode: "data",
  ...
  if (isMobile && mobileView === "card") {
    ...
    const primaryCol =
      visibleCols.find((col) =>
        ["acctName", "acctCode", "rcCode", "cutoffCode", "groupId"].includes(col.key)
      ) || visibleCols[0];
