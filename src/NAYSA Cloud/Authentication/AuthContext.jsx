...
//       } catch (err) {
//         const status = err?.response?.status;
//          if ((status === 401 || status === 403 || status === 419) && !isBioAuthInProgress()) {
//           await serverLogout("remote");
//         }
//       }
//     };
...
// const loginWithBiometricPasswordless = useCallback(
//   async ({ companyCode, payload }) => {
//     setTenant(companyCode);
...
//         login,
//         loginWithBiometric,
//         loginWithBiometricPasswordless,
//         logout,
//         setUser,
//         companyInfo,
//         getAllDropDown,
...
//   const loginWithBiometric = useCallback(async ({ companyCode, payload }) => {
//     setTenant(companyCode);
