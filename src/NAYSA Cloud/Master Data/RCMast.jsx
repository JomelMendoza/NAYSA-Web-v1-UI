...
const RCMast = () => {
  ...
  return (
    <div className="global-ref-main-div-ui">
        ...
        <div className="w-full flex flex-col gap-3 md:grid md:grid-cols-3 md:items-center">
          ...
          <div className="flex flex-col">
            <h1 className="global-ref-headertext-ui text-center md:text-left">
              {reftables[docType] || "Responsibility Center"}
            </h1>
          </div>
      ...
      {/* {activeTab === "rctype" && (
        <div className="mt-32 p-6 flex items-center justify-center italic text-gray-400">       
            <RCType />
        </div>
      )} */}
  ...
  <div className="mt-24 px-4">
    ...
    />
      ...
      {/* <SearchRcRef
        ...
        onClose={(v) => {
          if (v) {
            setField("rcTypeCode", v.rcTypeCode);
            setField("rcTypeName", v.rcTypeName);
          }
